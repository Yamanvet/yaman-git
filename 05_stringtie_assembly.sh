#!/bin/bash
OUTDIR="/home/vet/CTVT_raw_fastq_36samples/stringtie_v3"
FIXED="$OUTDIR/fixed_annotation.gtf"
BAMDIR="/home/vet/CTVT_raw_fastq_36samples/star_aligned_v3"

BAMS=($(find $BAMDIR -name "*_Aligned.sortedByCoord.out.bam" | sort))
TOTAL=${#BAMS[@]}
echo "Starting StringTie on $TOTAL BAMs (4 at a time, 8 threads each)..."
...
echo ""
echo "[$(date +%H:%M)] StringTie Step 1 Complete: $DONE/$TOTAL"
