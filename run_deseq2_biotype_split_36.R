#!/usr/bin/env Rscript
# ====================================================================
# CTVT RNA-seq: DESeq2 Split by Biotype — 36 samples (no outliers removed)
...
OUTDIR <- file.path(BASE, "deseq2_biotype_split_36")
dir.create(OUTDIR, showWarnings = FALSE, recursive = TRUE)

# ── 1. Sample metadata (ALL 36) ────────────────────────────────────
cat("═══════════════════════════════════════════════════════════════\n")
cat("  CTVT DESeq2 — Biotype-Split Analysis (36 samples, no removal)\n")
cat("═══════════════════════════════════════════════════════════════\n\n")
...
cat("\n\n═══════════════════════════════════════════════════════════════\n")
cat("  36-sample biotype-split DESeq2 complete!\n")
cat("═══════════════════════════════════════════════════════════════\n")