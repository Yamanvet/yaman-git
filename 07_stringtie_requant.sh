#!/bin/bash
# CTVT StringTie Re-quant — RAW BAM on RAM DISK (no filtering)
OUTDIR="/home/vet/CTVT_raw_fastq_36samples/ballgown_v3"
MERGED="/home/vet/CTVT_raw_fastq_36samples/stringtie_v3/merged_stringtie_v3.gtf"
BAMDIR="/home/vet/CTVT_raw_fastq_36samples/star_aligned_v3"
RAMDISK="/dev/shm/ctvt"
LOGFILE="$OUTDIR/requant_ram.log"

echo "==================================================================" | tee "$LOGFILE"
echo "$(date): PURE RAM re-quant (no filtering) — sequential" | tee -a "$LOGFILE"
echo "==================================================================" | tee -a "$LOGFILE"
